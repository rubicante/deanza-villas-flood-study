...
format:
  html:
    ...
    css: outputs/report_spike/styles.css
    include-in-header:
      - text: |
...
![De Anza Villas in mapped flood context](outputs/figures/final_report/figure1_context_overview.png)
...
![1 m terrain background and the selected drainage fabric](outputs/figures/final_report/figure2_terrain_drainage.png)
...
![Exact parcel boundary versus the selected channel network](outputs/figures/final_report/figure3_parcel_overlap.png)
...
<iframe src="outputs/maps/parcel_overlay.html" width="100%" height="550" style="border: 1px solid #ddd; border-radius: 4px; margin: 1rem 0;"></iframe>
...
![Satellite validation summary](outputs/figures/final_report/figure5_satellite_validation.png)
...
<iframe src="outputs/maps/satellite_validation.html" width="100%" height="550" style="border: 1px solid #ddd; border-radius: 4px; margin: 1rem 0;"></iframe>
...
<iframe src="outputs/maps/wash_extraction.html" width="100%" height="500" style="border: 1px solid #ddd; border-radius: 4px; margin: 1rem 0;"></iframe>
