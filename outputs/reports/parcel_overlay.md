...
- Metrics CSV: `data/processed/terrain/deanza_villas_2km_1m/parcels/parcel_overlay_metrics.csv`
- Metrics JSON: `data/processed/terrain/deanza_villas_2km_1m/parcels/parcel_overlay_metrics.json`
...
- Canonical parcel overlay map: `outputs/maps/parcel_overlay.html`
