...
- Fan synthesis report: `outputs/reports/fan_synthesis.md`
- Fan synthesis map: `outputs/maps/fan_synthesis.html`
- Terrain stats CSV: `data/processed/terrain/deanza_villas_2km_1m/fan_synthesis/fan_synthesis_stats.csv`
- Terrain stats JSON: `data/processed/terrain/deanza_villas_2km_1m/fan_synthesis/fan_synthesis_stats.json`
...
- Parcel overlay metrics used here: `data/processed/terrain/deanza_villas_2km_1m/parcels/parcel_overlay_metrics.csv`
