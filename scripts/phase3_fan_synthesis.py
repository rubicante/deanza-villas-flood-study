...
def main() -> None:
    parser = argparse.ArgumentParser(description="Complete Phase 3 fan-activity synthesis for De Anza Villas.")
    ...
    stats_csv = outdir / "phase3_fan_synthesis_stats.csv"
    stats_json = outdir / "phase3_fan_synthesis_stats.json"
